...
install_XrayR() {
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/18263531071/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
    wget https://cdn.jsdelivr.net/gh/18263531071/XrayR-V2Board/blockList  -O /etc/XrayR/rulelist
